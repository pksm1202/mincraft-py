...
grass = Audio('assets/1',autoplay=False)
stone_left = Audio('assets/2-left',autoplay=False)
stone_right = Audio('assets/2-right',autoplay=False)
gold = Audio('assets/1',autoplay=False)
...
blocks = [
    ...
    load_texture('assets/wood.png'),  # 4
]
